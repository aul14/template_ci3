        ...
        <div class="navbar-container" id="navbar-container">
            <div class="navbar-header pull-left">
                <a href="top-menu.html" class="navbar-brand">
                    <small>
                        <img src="<?php echo base_url(); ?>assets/ico/icon3.png"> Testing Aplikasi
                    </small>
                </a>
            </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo base_url('login'); ?>" method="post" class="login-form" onsubmit="return cekform();">
                            ...
                            <?php } ?>
                            <div class="center">
                                <h4><b>Testing Aplikasi</b></h4>
                            </div>
                            <hr>
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                                    <input type="text" autocomplete="off" name="username" placeholder="Username..." class="form-control" id="username" required="required" autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <button type="submit" name="submit" class="btn btn-labeled btn-success" id="button1" disabled>
