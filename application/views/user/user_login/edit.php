<div class="page-header">
  <h1>Tambah <small><i class="ace-icon fa fa-angle-double-right"></i>Userlogin</small></h1>
</div>
<!-- /.page-header -->
...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="POST" action="<?php echo base_url('user/userlogin/edit/' . $userlogin->id_login); ?>" data-parsley-validate="true">
        ...
        <div class="col-sm-5">
          <select class="chosen-select form-control" id="form-field-select-3" name="id_group" data-parsley-required="true" data-placeholder="Pilih User Group...">
            <?php foreach ($group as $group) { ?>
              <option></option>
              <option value="<?php echo $group->id_group ?>" <?php if ($userlogin->id_group == $group->id_group) {
                                                                echo "selected";
                                                              }; ?>>
      ...
      <!-- <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right">User Akses</label>
        <div class="col-sm-5">
          <select class="chosen-select form-control" id="form-field-select-3" name="id_akses" data-placeholder="Pilih User Akses...">
            <option></option>
            <option value="1" <?php if ($userlogin->id_akses == "1") {
                                echo "selected";
