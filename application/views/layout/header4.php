                  ...
                  <a href="<?php echo base_url('transaksi_hrd/status_karyawan/tambah_tampil/' . $jumlah_kontrak->NIK) ?>" class="clearfix">
                    ...
                    <span class="msg-body">
                      ...
                      <span class="msg-time">
                        ...
                        <span>
                          <!-- <?php echo $jumlah_kontrak->selisih; ?> --> Hari Lagi
                        </span>
                      </span>
                    </span>
                  </a>
                ...
                <li>
                  <a href="<?php echo base_url('transaksi_hrd/status_karyawan/tambah_tampil/' . $jumlah_harian->NIK) ?>" class="clearfix">
                    ...
                    <span class="msg-body">
                      <span class="msg-title">
                        <span class="blue">
                          <!-- <?php echo $jumlah_harian->namaKaryawan; ?> -->
                        </span>
                      </span>
                      <span class="msg-time">
                        <i class="ace-icon fa fa-clock-o"></i>
                        <span>
                          <!-- <?php echo $jumlah_harian->selisih; ?> --> Hari Lagi
                        </span>
                      </span>
                    </span>
                  </a>
